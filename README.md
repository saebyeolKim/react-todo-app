...
### 📦 기본 과정
- [Section 1: 쿠버네티스 기본 개념 / Section 2: 파드(Pod)를 활용해 서버 띄워보기](kubernates/section1&2.md)
- [Section 3: 디플로이먼트(Deployment), 서비스(Service)를 활용해 서버 띄워보기](kubernates/section3.md)
